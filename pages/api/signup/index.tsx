...
export default async function handler(
    ...
    if (req.method === "POST") {
		...
		if (!result.success) {
            ...
            VALUES (?, ?, ?, ?, ?, ?, ?)`,
					[result.data.student_id.substring(0, result.data.student_id.indexOf("@")), result.data.password, result.data.first_name, result.data.last_name, result.data.year, 0, result.data.primary_major],
